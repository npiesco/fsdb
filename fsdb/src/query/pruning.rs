...
fn extract_predicates_from_expr(expr: &datafusion::sql::sqlparser::ast::Expr, predicates: &mut Vec<(String, String, serde_json::Value)>) {
    use datafusion::sql::sqlparser::ast::{Expr, BinaryOperator};
